...
//Answer POST & PUTs
  a: {
    ...
    helpful: (req, res)=> {
      axios.put(`https://app-hrsei-api.herokuapp.com/api/fec2/hr-sfo/qa/questions/${req.query.answer_id}/helpful`, {}, {
        headers: {
          Authorization: auth
        },
      })
    ...
    report: (req, res)=>{
      axios.put(`https://app-hrsei-api.herokuapp.com/api/fec2/hr-sfo/qa/questions/${req.query.answer_id}/report`, {}, {
        headers: {
          Authorization: auth
        },
      })
